	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        else
        {
            ...
            else
            {
                ...
                if(!flag1) return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
                EntityCanoe entityboat = new EntityCanoe(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
