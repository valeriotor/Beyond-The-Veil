...
public class Registration {
    ...
    public static final RegistryObject<SacrificeAltarBlock> SACRIFICE_ALTAR = BLOCKS.register("sacrifice_altar", () -> new SacrificeAltarBlock(BlockBehaviour.Properties.of().noOcclusion().strength(3.0F, 1000.0F).requiresCorrectToolForDrops())); // new BlockSacrificeAltarCore(Material.IRON, BlockNames.SACRIFICE_ALTAR);
    public static final RegistryObject<BloodBasinBlock> BLOOD_BASIN = BLOCKS.register("blood_basin", () -> new BloodBasinBlock(BlockBehaviour.Properties.of().explosionResistance(1000))); // new BlockSacrificeAltarCore(Material.IRON, BlockNames.SACRIFICE_ALTAR);
    ...
    public static final RegistryObject<Item> SLUG = ITEMS.register("slug", () -> new SlugItem(new Item.Properties().food((new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).alwaysEat().build())));
    ...
    public static final RegistryObject<CreativeModeTab> TAB = CREATIVE_TAB.register("items", () -> CreativeModeTab.builder().icon(() -> new ItemStack(BLACK_MIRROR.get())).title(Component.translatable("creative_tab.beyondtheveil"))
            .displayItems((features, output) -> {
                ...
                output.accept(SWOLLEN_GROWTH.get());
