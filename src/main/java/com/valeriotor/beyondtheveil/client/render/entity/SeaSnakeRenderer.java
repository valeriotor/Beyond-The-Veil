...
public class SeaSnakeRenderer extends LivingEntityRenderer<SeaSnakeEntity, SeaSnakeModel> {
    ...
    public SeaSnakeRenderer(EntityRendererProvider.Context context) {
        super(context, new SeaSnakeModel(context.bakeLayer(SeaSnakeModel.LAYER_LOCATION)), 0.6F);
    }

    @Override
    protected boolean shouldShowName(SeaSnakeEntity pEntity) {
    ...
    @Override
    public ResourceLocation getTextureLocation(SeaSnakeEntity pEntity) {
        return TEXTURE;
    }
}
