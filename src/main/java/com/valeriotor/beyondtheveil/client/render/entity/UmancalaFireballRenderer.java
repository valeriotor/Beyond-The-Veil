...
public class UmancalaFireballRenderer extends EntityRenderer<UmancalaFireball> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(References.MODID, "textures/entity/ictya/umancala_fireball.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public UmancalaFireballRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(UmancalaFireball pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(UmancalaFireball pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    public ResourceLocation getTextureLocation(UmancalaFireball pEntity) {
