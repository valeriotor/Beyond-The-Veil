...
import com.valeriotor.beyondtheveil.client.model.entity.Abomination2Model;
...
public class Abomination2Renderer extends LivingEntityRenderer<LivingEntity, Abomination2Model> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(References.MODID, "textures/entity/abomination2.png");


    public Abomination2Renderer(EntityRendererProvider.Context context) {
        super(context, new Abomination2Model(context.bakeLayer(Abomination2Model.LAYER_LOCATION)), 1F);
    }
