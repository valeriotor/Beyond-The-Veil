...
public class SeaSnakeModel extends AnimatedModel<SeaSnakeEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Tail = partdefinition.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(14, 1).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.6F, 13.4F, -16.25F));
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0F, -1.75F, -7.25F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 22).addBox(1.5F, -1.0F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 22).addBox(-1.5F, -1.0F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 13.75F, -14.75F, 0.0873F, 0.0F, 0.0F));
