...
public class TestNautilus<T extends NautilusEntity> extends EntityModel<T> {
    ...
    private final ModelPart left_propeller;
    private final ModelPart left_propeller_texture;
    private final ModelPart right_propeller;
    private final ModelPart right_propeller_texture;
    private final ModelPart glass;
    private final ModelPart left_levers;
    private final ModelPart lever_up;
    private final ModelPart lever_down;

    public TestNautilus(ModelPart root) {
        this.rotate_fix = root.getChild("rotate_fix");
        this.front = rotate_fix.getChild("front");
        this.back = rotate_fix.getChild("back");
        this.steer = front.getChild("steer");
        this.glass = front.getChild("glass");
        this.left_levers = glass.getChild("left_levers");
        this.lever_up = left_levers.getChild("lever_up");
        this.lever_down = left_levers.getChild("lever_down");
        this.top = root.getChild("top");
        this.propeller = back.getChild("propeller");
        this.left_propeller = rotate_fix.getChild("left_propeller");
        this.left_propeller_texture = left_propeller.getChild("left_propeller_texture");
        this.right_propeller = rotate_fix.getChild("right_propeller");
        this.right_propeller_texture = right_propeller.getChild("right_propeller_texture");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rotate_fix = partdefinition.addOrReplaceChild("rotate_fix", CubeListBuilder.create().texOffs(303, 308).addBox(9.0F, -4.0F, -31.0F, 9.0F, 2.0F, 62.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(304, 160).addBox(10.0F, -14.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(232, 160).addBox(9.0F, -18.0F, -6.0F, 9.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(214, 145).addBox(6.0F, -29.0F, -6.0F, 3.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
        ...
        PartDefinition cube_r3 = glass.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 83).addBox(-5.0F, -7.25F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(-6.0F, -7.0F, -4.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 83).addBox(-5.0F, -7.25F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(-6.0F, -7.0F, 0.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 83).addBox(3.0F, -7.25F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(2.0F, -7.0F, 0.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 83).addBox(-1.0F, -7.25F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(-2.0F, -7.0F, 0.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 83).addBox(-1.0F, -7.25F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(-2.0F, -7.0F, -4.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 83).addBox(3.0F, -7.25F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(2.0F, -7.0F, -4.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 79).addBox(-8.0F, -6.5F, -8.0F, 16.0F, 13.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(23.2606F, -7.25F, 18.4852F, 0.0F, 2.7489F, 0.0F));

        PartDefinition cube_r4 = glass.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 52).addBox(-8.0F, -6.51F, -7.3F, 16.0F, 13.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(33.6399F, -7.23F, 24.733F, 0.0F, 2.2689F, 0.0F));

        PartDefinition cube_r5 = glass.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 456).addBox(0.51F, -37.99F, -12.3F, 16.0F, 13.0F, 14.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r6 = glass.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 446).addBox(-6.5F, -0.5F, -3.5F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(0, 446).addBox(-1.5F, -0.5F, -3.5F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(25.379F, -13.5F, 58.0962F, 0.0F, 0.3927F, 0.0F));

        PartDefinition cube_r7 = glass.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 483).addBox(0.49F, -38.0F, -14.75F, 16.0F, 13.0F, 16.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r8 = glass.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(242, 340).addBox(-0.1567F, -0.5F, -2.4633F, 1.0F, 1.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(40.943F, -60.4F, 27.9343F, 0.0F, -1.1345F, 0.0F));

        PartDefinition cube_r9 = glass.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(242, 340).addBox(0.5F, -29.9F, -1.0F, 1.0F, 1.0F, 29.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r10 = glass.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 134).addBox(0.5F, -31.0F, -1.0F, 16.0F, 58.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.0F, -30.0F, 9.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition cube_r11 = glass.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(242, 340).addBox(-0.1567F, -0.5F, -26.5367F, 1.0F, 1.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(40.943F, -60.46F, 50.0657F, 0.0F, 1.1345F, 0.0F));

        PartDefinition left_levers = glass.addOrReplaceChild("left_levers", CubeListBuilder.create(), PartPose.offsetAndRotation(25.379F, -13.0F, 58.0962F, 0.0F, 0.3927F, 0.0F));

        PartDefinition lever_up = left_levers.addOrReplaceChild("lever_up", CubeListBuilder.create().texOffs(14, 475).addBox(-0.479F, -7.0F, -0.3462F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(6, 465).addBox(-0.979F, -10.0F, -0.8462F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition lever_down = left_levers.addOrReplaceChild("lever_down", CubeListBuilder.create().texOffs(14, 475).addBox(-0.479F, -7.0F, -0.3462F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(6, 465).addBox(-0.979F, -10.0F, -0.8462F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition steer = front.addOrReplaceChild("steer", CubeListBuilder.create().texOffs(23, 0).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(48, 0).addBox(-1.5F, -6.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(1.5F, -5.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(18, 6).addBox(5.3F, -5.0F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(3.5F, -5.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(7.3F, -5.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-8.3F, -5.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 6).addBox(-7.3F, -5.0F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(-3.5F, -5.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-5.5F, -5.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(31.5F, -12.0F, 39.0F, 0.0F, 0.0F, -0.9163F));

        PartDefinition cube_r12 = steer.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(24, 1).addBox(-8.3F, -5.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-5.5F, -5.1F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(-3.5F, -5.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-7.3F, -5.1F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(7.3F, -5.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(3.5F, -5.1F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(5.3F, -5.1F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(1.5F, -5.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 2.3562F, 0.0F));

        PartDefinition cube_r13 = steer.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(18, 0).addBox(-7.3F, -5.1F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(-3.5F, -5.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-8.3F, -5.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-5.5F, -5.1F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(1.5F, -5.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(5.3F, -5.1F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(7.3F, -5.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(3.5F, -5.1F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition cube_r14 = steer.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(24, 1).addBox(7.3F, -5.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(3.5F, -5.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 6).addBox(5.3F, -5.0F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(1.5F, -5.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-8.3F, -5.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 1).addBox(-5.5F, -5.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(23, 0).addBox(-3.5F, -5.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(18, 6).addBox(-7.3F, -5.0F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
    ...
    @Override
    public void prepareMobModel(T entity, float pLimbSwing, float pLimbSwingAmount, float partialTicks) {
        steer.yRot = -0.1F * entity.getSteer(partialTicks);
        lever_down.xRot = -0.3054F + 0.6F * entity.getLever(1, partialTicks) / 20;
        lever_up.xRot = -0.3054F + 0.6F * entity.getLever(0, partialTicks) / 20;
        left_propeller_texture.xRot = entity.getPaddleState(0) ? (entity.tickCount + partialTicks) : 0.3491F;
        right_propeller_texture.xRot = entity.getPaddleState(1) ? (entity.tickCount + partialTicks) : 0.3491F;
        propeller.xRot = entity.getPaddleState(0) || entity.getPaddleState(0) ? (entity.tickCount + partialTicks)/2 : -19;;
    }
