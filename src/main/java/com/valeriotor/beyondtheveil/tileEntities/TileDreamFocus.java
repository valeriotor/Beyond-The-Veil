...
public class TileDreamFocus extends TileEntity implements ITickable{
	...
	public void update() {
		if(this.world.isRemote) {
			...
			this.counter++;
			if(this.counter > 150) {
				EntityDreamItem edi = new EntityDreamItem(this.world, this.pos.getX()+0.5, this.pos.getY()+1, this.pos.getZ()+0.5, new ItemStack(BlockRegistry.BlockPenitenceStatue));
				this.ents.add(edi);
