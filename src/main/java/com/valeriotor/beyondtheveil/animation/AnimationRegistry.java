...
public class AnimationRegistry {
    ...
    public static AnimationTemplate blood_cultist_kill_keeper_spare_cultist;
    public static AnimationTemplate blood_cultist_killed_by_player;
    ...
    public static AnimationTemplate player_kill_keeper_fp;
    public static AnimationTemplate player_kill_keeper_tp;
    public static AnimationTemplate player_slim_kill_cultist_fp;
    public static AnimationTemplate player_slim_kill_cultist_tp;
    public static AnimationTemplate player_slim_kill_keeper_fp;
    public static AnimationTemplate player_slim_kill_keeper_tp;
    ...
    public static AnimationTemplate shoreman_keeper_death_player;
    ...
    public static void loadAnimations(boolean client) {
        ...
        blood_cultist_kill_keeper_spare_cultist = registerAnimation("blood_cultist_kill_keeper_spare_cultist", client, i++);
        blood_cultist_killed_by_player = registerAnimation("blood_cultist_killed_by_player", client, i++);
        ...
        player_kill_keeper_fp = registerAnimation("wrapped/player_kill_keeper_fp", client, i++);
        player_kill_keeper_tp = registerAnimation("wrapped/player_kill_keeper_tp", client, i++);
        ...
        player_slim_kill_keeper_fp = registerAnimation("wrapped/player_slim_kill_keeper_fp", client, i++);
        player_slim_kill_keeper_tp = registerAnimation("wrapped/player_slim_kill_keeper_tp", client, i++);
        ...
        shoreman_keeper_death_player = registerAnimation("shoreman/keeper_death_player", client, i++);
