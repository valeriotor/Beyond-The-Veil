...
public class BTVBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<PillarBE>> DEMAND_PILLAR_BE = BLOCK_ENTITIES.register(Registration.DEMAND_PILLAR.getId().getPath(), () -> BlockEntityType.Builder.of((i, o) -> new PillarBE(BTVBlockEntities.DEMAND_PILLAR_BE.get(), i, o), Registration.DEMAND_PILLAR.get()).build(null));
