...
public class BTVEntities {
    ...
    public static final RegistryObject<EntityType<SurgeonEntity>> SURGEON = ENTITIES.register("surgeon", () -> EntityType.Builder.of(SurgeonEntity::new, MobCategory.MONSTER).sized(1.6F, 3F).clientTrackingRange(32).build("surgeon"));
