...
public enum BloodPoolEntityType {
    ...
    ABOMINATION1(BTVEntities.ABOMINATION_1.get(), 50, l -> new Abomination0Entity(BTVEntities.ABOMINATION_1.get(), l)),
    ABOMINATION2(null, 70, null),
    BLOOD_SKELETON(BTVEntities.BLOOD_SKELETON.get(), 70, l -> new Abomination0Entity(BTVEntities.BLOOD_SKELETON.get(), l)),
    BLOOD_ZOMBIE(BTVEntities.BLOOD_ZOMBIE.get(), 50, l -> new Abomination0Entity(BTVEntities.BLOOD_ZOMBIE.get(), l)),
    VILLAGER(EntityType.VILLAGER, 20, l -> new Villager(EntityType.VILLAGER, l)),
    WEEPER(BTVEntities.WEEPER.get(), 20, l -> new Abomination0Entity(BTVEntities.WEEPER.get(), l));
