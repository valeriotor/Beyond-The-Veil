    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                CanoeEntity canoe = new CanoeEntity(pLevel, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
                canoe.setYRot(pPlayer.getYRot());
                if (!pLevel.noCollision(canoe, canoe.getBoundingBox())) {
